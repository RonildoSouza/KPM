...
class PostItRepository extends EntityRepository
{
    ...
    public function getPostIts($withComments = false)
    {
        ...
        $dql = sprintf($this->strFormat, $slcCMTs, POSTIT_ENTITY_NAME, $joinCMTs, "ORDER BY p.id");
    ...
    public function getPostItById($id, $withComments = false)
    {
        ...
        $dql = sprintf($this->strFormat, $slcCMTs, POSTIT_ENTITY_NAME, $joinCMTs, "WHERE p.id = ?1");
